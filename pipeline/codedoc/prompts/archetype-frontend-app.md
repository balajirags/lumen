...
- Required target-state outputs are frontend boundaries and a migration plan.
...
- Use the C4 diagram tool for C4 context/target diagrams; use Mermaid for journey and other frontend diagrams.
